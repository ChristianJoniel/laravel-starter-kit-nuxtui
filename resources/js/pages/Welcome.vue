...
<template>
    <div>
        ...
        <UPageSection>
            <UPageCTA
                title="Ready to build your next Laravel app?"
                description="Join thousands of developers building with Laravel and Nuxt UI. Get this template and start shipping today."
                variant="subtle"
                :links="[
                    {
